...
This page describes how to contribute to [MyPkg37.jl](https://github.com/ohno/MyPkg37.jl).

## Contributing

The [ColPrac](https://github.com/SciML/ColPrac) guidelines is recommended. Please open an [issue](https://github.com/ohno/MyPkg37.jl/issues) before starting significant work.

## Versioning

This project follows [Semantic Versioning](https://semver.org/). When bumping the version, update the version number in:
- [Project.toml](https://github.com/ohno/MyPkg37.jl/blob/main/Project.toml#L4)
- [CITATION.bib](https://github.com/ohno/MyPkg37.jl/blob/main/CITATION.bib#5)
...
Use these commands to add `PkgName.jl` as a dependency. `Pkg.add` updates [Project.toml](https://github.com/ohno/MyPkg37.jl/blob/main/Project.toml). If dependencies were edited manually, run `Pkg.resolve()` and `Pkg.instantiate()`.
